...
%%% Essentials
\name{Gareth C.}{George}
\address{80 De Sabla Road, Hillsborough CA 94010}
\mobile{650-576-2199}
%%% Social
\email{garethgeorge97@gmail.com}
% \homepage{www.garethgeorge.com}
\githuba{thelastpenguin}
\githubb{garethgeorge}
\linkedin{gareth-george-b7463399}
%%% Optionals
\position{Software Engineer} %{\enskip\cdotp\enskip}Security Expert%}

% TODO: find a better quote maybe
